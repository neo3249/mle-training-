...
DATA_PATH = "C:/Users/achal.sajeev/Downloads/mle-training-/src/housing/data"
MODEL_PATH = "C:/Users/achal.sajeev/Downloads/mle-training-/src/housing/data"
...
def main():
    ...
    housing_prepared_tr.to_csv(os.path.join(DATA_PATH, "train_processed.csv"), index=False)

    X_test_prepared_tr.to_csv(os.path.join(DATA_PATH, "valid_processed.csv"), index=False)

    with open(os.path.join(MODEL_PATH, "linear_model.pkl"), "wb") as file:
        pickle.dump(lin_reg, file)

    logger.info(f"Saved processed datasets at {DATA_PATH} and model pickle at {MODEL_PATH}")
